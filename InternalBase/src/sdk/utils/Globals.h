...
namespace Globals
{
    ...
    struct LegitWeaponProfile {
        ...
        int   rcs_key           = 0;
        bool  rcs_silent        = true;   // true=silent (server-side), false=legit (camera pull)
    ...
    inline bool misc_quickstop     = false;
    ...
    inline bool  legit_no_spread           = false;   // zero spread/inaccuracy VData (legit tab)
    inline bool  rage_no_spread            = false;   // zero spread/inaccuracy VData (rage tab)
