...
void c_inventory_changer::run(int stage)
{
    ...
    __try {
        ...
        uintptr_t entityList = *reinterpret_cast<uintptr_t*>(client + 0x24E6590);
        uintptr_t ctrl = *reinterpret_cast<uintptr_t*>(client + 0x231F700);
        if (!ctrl) return;

        uintptr_t inv_svc = *reinterpret_cast<uintptr_t*>(ctrl + OFF_INV_SERVICES);
        uintptr_t pawn = *reinterpret_cast<uintptr_t*>(client + 0x2340698);
