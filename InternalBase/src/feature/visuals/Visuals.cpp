...
namespace ThirdPerson {
    static void Update() {
        ...
        // m_bInThirdPerson = 0x229 (актуальный оффсет).
        // Пишем каждый кадр чтобы движок не сбрасывал значение при рестарте/респауне.
        uintptr_t input = client + Offsets::dwCSGOInput;
        SafeWriteU8(input + Offsets::m_bInThirdPerson,
