...
namespace Globals
{
    ...
    inline int  skin_changer_paint_kit = 1;   // индекс в списке доступных раскрасок
    ...
    inline int  knife_changer_model = 0;       // индекс в g_item_schema->knives
    ...
    inline int  glove_changer_model = 0;       // индекс в g_item_schema->gloves
